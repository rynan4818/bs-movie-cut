...
class Modaldlg_db_view < VRModalDialog
  ...
  def construct
    ...
    addControl(VRButton,'button_add_folder',"Add a folder to be searched",312,296,240,32)
    ...
    addControl(VRCheckbox,'checkBox_cut_only',"Cut movie only mode",40,360,176,24)
