...
class Modaldlg_setting < VRModalDialog
  ...
  def construct
    ...
    addControl(VREdit,'edit_max_volume',"0",512,344,56,24)
    ...
    addControl(VRStatic,'static12',"dB",568,344,24,24)
    addControl(VRStatic,'static13',"Audio normalize",344,344,120,24)
    addControl(VRStatic,'static14',"max=",472,344,40,24)
...
class Form_main < VRForm
  ...
  def construct
    ...
    addControl(VRCheckbox,'checkBox_normalize',"Audio normalize",360,696,136,24)
