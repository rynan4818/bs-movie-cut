...
class Modaldlg_setting < VRModalDialog
  ...
  def construct
    self.caption = 'Setting'
    self.move(226,71,655,855)
    addControl(GroupBox_Preview,'groupBox_Preview',"Preview encode",24,462,296,84)
    addControl(VRButton,'button_cancel',"CANCEL",400,754,96,32)
    addControl(VRButton,'button_db_select',"select",560,40,56,24)
    addControl(VRButton,'button_default',"DEFAULT",464,618,88,24)
    addControl(VRButton,'button_hdt_select',"select",560,96,56,24)
    addControl(VRButton,'button_obs_dir_select',"select",560,152,56,24)
    addControl(VRButton,'button_ok',"OK",520,754,96,32)
    addControl(VRButton,'button_opendir_select',"select",488,310,56,24)
    addControl(VRButton,'button_parameter',"parameter manual",464,642,152,24)
    addControl(VRButton,'button_preview_select',"select",376,374,56,24)
    addControl(VRButton,'button_preview_temp',"select",552,430,64,24)
    addControl(VRButton,'button_subtitle_temp',"select",552,578,64,24)
    addControl(VRCheckbox,'checkBox_ascii',"Remove non-ASCII code",24,738,296,24)
    addControl(VRCheckbox,'checkBox_japanese',"Japanese mode (After restart)",376,690,240,24)
    addControl(VRCheckbox,'checkBox_newcheck',"Check latest version",24,690,288,24)
    addControl(VRCheckbox,'checkBox_no_message',"Do not show message for timestamp check",24,246,328,24)
    addControl(VRCheckbox,'checkBox_obs_log_check',"Get video timestamp from OBS Studio Log file",24,184,496,24)
    addControl(VRCheckbox,'checkBox_stop_time_menu',"Use endtime for stoptime",24,610,216,24)
    addControl(VRCheckbox,'checkBox_timesave',"Saves and reads the original movie file's timestamp the database. (recommended)",24,214,592,24)
    ...
    addControl(VREdit,'edit_max_volume',"0",512,470,56,24)
    addControl(VREdit,'edit_obs_dir',"",24,152,536,24)
    addControl(VREdit,'edit_offset',"0.0",512,506,56,32)
    ...
    addControl(VRStatic,'static10',"open movie folder",24,286,136,24)
    addControl(VRStatic,'static11',"default extension",544,270,72,40)
    ...
    addControl(VRStatic,'static4',"preview tool",24,350,112,24)
    addControl(VRStatic,'static5',"preview temporary file (HDD recommended to prevent SSD degradation)",24,406,520,24)
    addControl(VRStatic,'static6',"offset time",432,514,80,24)
    addControl(VRStatic,'static7',"sec",568,514,32,24)
    addControl(VRStatic,'static8',"subtitle temporary file [Cannot use half-width spaces in the path] (HDD recommended)",24,554,608,24)
    addControl(VRStatic,'static9',"preview tool option",448,350,168,24)
  end 
