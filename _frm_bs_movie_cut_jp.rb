...
class Modaldlg_setting < VRModalDialog
  ...
  def construct
    ...
    addControl(VREdit,'edit_max_volume',"0",520,344,56,24)
    addControl(VREdit,'edit_offset',"0.0",520,384,56,28)
    ...
    addControl(VRStatic,'static12',"音声の正規化",344,344,96,24)
    addControl(VRStatic,'static13',"dB",584,344,24,24)
    addControl(VRStatic,'static14',"最大値=",456,344,64,24)
...
class Form_main < VRForm
  ...
  def construct
    ...
    addControl(VRCheckbox,'checkBox_normalize',"音声の正規化",328,696,160,24)
