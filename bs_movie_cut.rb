...
DEFAULT_FFMPEG_OPTION  = ["#DEFALUT#  -c copy -async 1",
                          "#Twitter 2kbps#  -r 40 -c:v libx264 -pix_fmt yuv420p -strict -2 -c:a aac -b:v 1878k -minrate 1878k -maxrate 1878k -bufsize 1878k -b:a 128k -async 1 -vsync cfr -s 1280x720",
