...
HDT_FILE_SELECT_TITLE           = "HMDDistance file 'HMDDistance.dat' select"
MOVIE_FILE_SELECT_TITLE         = "Movie file select"
SELECT_OPEN_MOVIE_FOLDER_TITLE  = "select open movie folder"
SELECT_OPEN_OBSLOG_FOLDER_TITLE = "Log folder selection in OBS Studio"
...
LATEST_MOVIE_OPEN_ERR_MES       = "Set the open movie folder and default extension in the Setting section of Option."
LATEST_MOVIE_OPEN_ERR_MES_TITLE = "Open latest movie error"
